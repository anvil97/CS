...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { condition: @promotion.condition, from_date: @promotion.from_date, name: @promotion.name, to_date: @promotion.to_date } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { condition: @promotion.condition, from_date: @promotion.from_date, name: @promotion.name, to_date: @promotion.to_date } }
